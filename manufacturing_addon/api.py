...
def add_parameter(doc, method):
    ...
    # Bundle Detail / Product Combo Item must be set manually (Item Bundle page
    # or Product Combo Item table). Do NOT auto-copy from Stitching Size
    # combo_detail on create/save — that kept re-filling DUVET/PILLOW.
